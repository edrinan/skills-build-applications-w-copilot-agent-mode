...
class APITest(TestCase):
    def setUp(self):
        ...
        self.activity = Activity.objects.create(user='ironman', activity_type='Running', duration=30, team='Marvel')
        self.leaderboard = Leaderboard.objects.create(team='Marvel', points=100)
        self.workout = Workout.objects.create(name='Super Strength', description='Strength workout', suggested_for='Marvel')
